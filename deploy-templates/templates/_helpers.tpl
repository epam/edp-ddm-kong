...
{{- else if and (not .Values.global.registry.kong.istio.sidecar.resources.limits.cpu) .Values.global.istio.sidecar.resources.limits.cpu }}
...
{{- else if and (not .Values.global.registry.kong.istio.sidecar.resources.limits.memory) .Values.global.istio.sidecar.resources.limits.memory }}
...
{{- else if and (not .Values.global.registry.kong.istio.sidecar.resources.requests.cpu) .Values.global.istio.sidecar.resources.requests.cpu }}
...
{{- else if and (not .Values.global.registry.kong.istio.sidecar.resources.requests.memory) .Values.global.istio.sidecar.resources.requests.memory }}
